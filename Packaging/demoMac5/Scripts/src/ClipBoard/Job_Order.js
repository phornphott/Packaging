angular.module('AceApp').controller('JobOrderController', ['$scope', '$rootScope', '$stateParams', '$http',
    function ($scope, $rootScope, $stateParams, $http) {
        //LoadGrid();
        $("#popup").dxPopup({
            title: "โหลดใบแจ้งการผลิต",
            visible: false,
            width: 600,
            height: 520,
        });
        ...
        //load file
        $scope.getSalesRequestion = function () {
            ...
            $.get("../PurchaseOrder/GetSalesRequestion")
                .done(function (res) {
                    ...
                    if (res.success == true) {
                        ...
                        $('#salesRequisitionGrid').dxDataGrid({
                            dataSource: res.data,
                            showBorders: true,
                            showRowLines: true,
        ...
        //set sale requisition
        $scope.setSalesRequest = function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success == true) {
                        ...
                        LoadGrid();
                        DevExpress.ui.notify("โหลดใบแจ้งการผลิตแล้ว ");
                    } else {
