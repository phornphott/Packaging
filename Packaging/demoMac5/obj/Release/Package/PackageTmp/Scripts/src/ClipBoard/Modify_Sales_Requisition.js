angular.module('AceApp').controller('ModifySalesRequisitionController', ['$scope', '$rootScope', '$stateParams', '$http',
    function ($scope, $rootScope, $stateParams, $http) {
        ...
        $scope.cancel = function () {
            window.location = "#/ClipBoard/Sales_Requestion";
        }

        $scope.Eidt = function (id) {

            var url = "../SalesRequestion/GetSalesRequestion" + id
            $.get(url)
                .done(function (res) {
                    if (res.success == true) {
        ...
        $scope.save = function () {
            if ($("#form-container").dxForm("instance").validate().isValid) {
                ...
                var dataObj = {
                    "Clipboard_Date_Str": convertDate(obj.Clipboard_Date),
                    "Clipboard_Desc": obj.Clipboard_Desc,
                    "Clipboard_Nos": obj.Clipboard_Nos,
                    "Clipboard_Quantity": obj.Clipboard_Quantity,
                    "Clipboard_Delivery_Desc": $("#form-container").dxForm("instance").getEditor("Delivery_Id").option("displayValue"),
                    "Delivery_Id": obj.Delivery_Id,
                    "Bag_Width": Number(grid1[1].col3),
                    "Bag_Lenght": Number(grid1[2].col3),
                    "Bag_Lenght_Add": Number(grid1[3].col3),
                    "Bag_Width_Add": Number(grid1[4].col3),
                    "Warpyarn_Denier": Number(grid1[6].col3),
                    "Warpyarn_Mech": Number(grid1[6].col4),
                    "Warpyarn_Width": Number(grid1[6].col5),
